...
3. Enter a command in the following format: madbuild -project [your project path] -target [your target name]
    - For example **madbuild -project c:\myFolder\myProject.flprj -target HTML5**
    ...
    - **Note:** You can use any scripting language to run the madbuild command. 
